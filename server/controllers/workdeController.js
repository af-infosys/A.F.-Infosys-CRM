...
export const getAllWork = async (req, res) => {
  try {
    ...
    const result = await sheet.read(process.env.DATAENTRY_SHEET_ID, "Index");
...
export const addWork = async (req, res) => {
  try {
    ...
    const newWork = await sheet.insert(
      process.env.DATAENTRY_SHEET_ID,
      "Index",
      [
        sheetId,
        JSON.stringify(spot),
    ...
    await sheet.createNewTab(process.env.DATAENTRY_SHEET_ID, `${sheetId}_Main`);
    await sheet.createNewTab(
      process.env.DATAENTRY_SHEET_ID,
      `${sheetId}_Areas`,
    );
...
export const deleteWork = async (req, res) => {
  try {
    ...
    await sheet.deleteTab(process.env.DATAENTRY_SHEET_ID, `${id}_Main`);
    await sheet.deleteTab(process.env.DATAENTRY_SHEET_ID, `${id}_Areas`);
