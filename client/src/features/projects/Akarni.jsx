...
const quicklinks = [
  ...
  { id: 2, label: "Akarni Report (No.8)", path: "/survay/akarniReport" },
  { id: 3, label: "Index Report", path: "/survay/indexReport" },
  { id: 4, label: "Tax Register (9D)", path: "/survay/taxRegister" },
          ...
          <div className="quicklinks-container">
            {quicklinks.map((item) => (
              <button
                ...
                onClick={() => navigate(`${item.path}/${project?._id}`)}
              >
                {item.id}. {item.label}
              </button>
            ))}
