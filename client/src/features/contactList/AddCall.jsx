  ...
  const fetchIndex = async () => {
    try {
      ...
      const defaultAnswers = [
        "1 પછી ફોન કરવો કામ માં છુ",
        "2 હશે તો કહેશે",
        "3 વિચારીને કહિશ",
        "4 બધુ કામ જાતે કરીએ છે",
        "5 અઘરા વર્તન ખરાબ પોતે કરીએ છે",
        "6 ઇન્ટરસ છે હા જરૂર છે",
        "7 ભાવ વધારે લાગે",
        "8 ફોન બંધ આવે છે",
        "9 સારો સ્વભાવના વ્યક્તિ",
        "10 રૂબરૂ મળવુ",
        "11 ફંડ નથી કામ કરાવવું છે, આવતા વર્ષે ફોન કરજો",
        "12 કોલ કરવો નહી કાયમી માટે",
        "13 સલાહકાર યાદી જુના અનુભવી",
        "14  એજન્ટ કામ માટે",
        "15 જુના કસ્ટમર અગાઉ કામ કરાવેલ",
      ];

      setServices([...serviceSet]);
      setAnswers([...defaultAnswers, ...answerSet]);
    } catch (err) {
      console.error("Error fetching records:", err);
    }
  };
