...
function BillViewDE() {
  ...
  const [letterPadView, setLetterPadView] = useState(true);
  ...
  const handleDownloadPdf3 = () => {
    const input = reportRef3.current;
    if (!input) return;
  ...
  const handleDownloadPdf4 = () => {
    const input = reportRef4.current;
    if (!input) return;
  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen flex justify-center items-center py-12 px-4">
      <div className="container mx-auto p-2 sm:p-6 lg:p-8 rounded-2xl max-w-4xl w-full">
        ...
        {/* Download PDF button */}
        <div className="flex justify-start p-4 mb-8">
          <button
            onClick={() => {
              setLetterPadView((prev) => !prev);
            }}
          ...
          >
            {letterPadView ? "Without Letter Pad" : "Show Letter Pad"}
          </button>
        </div>
        ...
        {letterPadView ? (
          <>
            {/* Header Section */}
            <h1 className="text-3xl font-bold text-center mb-6 mt-8 text-gray-800">
              Bill/Invoice
            </h1>
              ...
              >
                ...
                >
                  <div className="flex flex-col items-end w-full">
                    ...
                    >
                      ...
                      <h3 className="text-base font-grey-700">
                        Website :-{" "}
                        <span className="underline">afinfosys.com</span>
                      </h3>
                    </div>
                  </div>
                </div>
                ...
                <div id="title">
                  <div>
                    ...
                    <p className="trans">
                      ગ્રામપંચાયત રેવન્યુ(જમાબંધી) વાર્ષીક હિસાબ, આકાણીસર્વે,
                      કરવેરા રજીસ્ટર, રોજમેળ, ગ્રામસુવિધા પોર્ટલ તથા ઓનલાઈન /
                      ઓફલાઈન તમામ પ્રકારની ડેટાએન્ટ્રી અને પ્રિન્ટીંગ, વેબસાઈટ,
                      સોફ્ટવેર, કોમ્પ્યુટર કામ માટે મળો
                    </p>
                ...
                >
                    ...
                    <tr>
                      ...
                      >
                        <span className="trans">
                          આકારણી રજીસ્ટર કોમ્પ્યુટરાઇઝડ પ્રિન્ટ જોબ વર્કનું બિલ
                          સને. {billData?.year}
                        </span>
                      </th>
                    </tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      >
                        <span className="trans">
                          {billData?.gaam} આકારણી વર્ષ:- {billData.year} નું ગામ
                          નમુના નં. ૮ આકારણી રજીસ્ટર બનાવી અને ગા.ન.ન.- ૯/ડી
                          કરવેરા રજીસ્ટર બનાવિ કોમ્પ્યુટરાઈઝડ પ્રિન્ટ સાથે
                ...
                >
                  <thead>
                    <tr>
                      ...
                      >
                        <span className="trans">
                          ડેટા એન્ટ્રી કોમ્પ્યુટરાઈઝડ જોબ વર્ક વર્કનું બિલ વર્ષ.{" "}
                          {billData?.year}
                        </span>
                      </th>
                    </tr>
                    <tr>
                      ...
                      >
                        <span className="trans" style={{ textWrap: "wrap" }}>
                          ભાવ{" "}
                          <span style={{ textWrap: "nowrap" }}>(ઘર દીઠ)</span>
                        </span>
                      </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      >
                        <span className="trans">
                          ...
                          {billData.year} નું ગામ નમુના નં. ૮ આકારણી રજીસ્ટર ઘેર
                          ઘેર જઇને બનાવી અને ગા.ન.ન.- ૯/ડી કરવેરા રજીસ્ટર બનાવિ
                          કોમ્પ્યુટરાઈઝડ પ્રિન્ટ સાથે સ્પાઇરલ બાઈન્ડિંગ સાથે
                          ઓનલાઈન ગ્રામ સુવિધા પોર્ટલમાં ડેટાએન્ટ્રી સાથે
                          જોબવર્ક/મજુરીથી કમ્પલેટ અદ્યતન બનાવેલ
                        </span>
                      </td>
