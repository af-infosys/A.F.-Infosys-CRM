...
const BenefitPoint = ({ number, children }) => (
  <div className="flex text-lg text-gray-800 mb-4 items-start">
    <span className="font-extrabold text-blue-700 mr-3 mt-1">{number}.</span>
...
const PanchayatBenefit = () => {
  ...
  return (
    <div>
      {/* -------------------- 1. Main Title -------------------- */}
      <header className="text-center pb-12" style={{ marginTop: "80px" }}>
      ...
      <footer className="mt-10 pt-8 border-t-2 border-dashed border-gray-400">
        {/* Company Name */}
        ...
        <div className="text-center text-xl font-bold text-gray-700 mb-2">
          શાહિદ ડી. કાલવા - <span className="text-red-600">93764 43146</span>,
          સરફરાઝ કાલવા - <span className="text-red-600">99247 82732</span>
        </div>

        {/* Address */}
        <div className="text-center text-lg text-gray-600 mb-6">
          બીજા માળે, સેન્ટરલ પોઇન્ટ-ર કોમ્પ્લેક્ષ, જુના બસ સ્ટેન્ડ સાવરકુંડલા.
          તાલુકો:– સાવરકુંડલા. જીલ્લો:– અમરેલી (પશ્ચિમ ગુજરાત)
        </div>

        {/* Email and Website */}
        <div className="flex justify-center items-center space-x-12 text-lg font-semibold border-t border-gray-300 pt-4">
