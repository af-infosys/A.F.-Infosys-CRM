  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "19px", textIndent: "100px", lineHeight: "2.1" }}>
        ...
        ઠરાવ નંબર <span>{dummy?.resolutionNo || ".............."}</span> થી
        કરવામાં આવી આકારણી કમિટી રચના કર્યા બાદ ઘરે ઘરે તપાસ ફરીને આકારણીની
        પ્રાથમિક યાદિ તૈયાર કરી{" "}
        <span style={{ whiteSpace: "nowrap" }}>
        ...
        સદરહુ આકારણી કોઈ મિલ્કતના વાંધા સુચનો રજુ થયેલ ન હોય સને{" "}
        <span>{dummy?.effectiveYear || ".................."}</span> ના વર્ષથી
        ચાર વર્ષ માટે આકારેલ વેરાના દર લાગુ કરવાના માટે ગ્રામ પંચાયતની બેઠક નંબર{" "}
        <span>{dummy?.meetingNo || "............."}</span>{" "}
        <span style={{ whiteSpace: "nowrap" }}>
          {" "}
      ...
      <p style={{ fontSize: "19px", textIndent: "100px", lineHeight: "2.1" }}>
        સદરહુ આકારણી યાદિ મુજબના મિલ્કતના ક્રમ નંબર{" "}
        <span>{dummy?.propertyFrom || ".............."}</span> થી ક્રમ નંબર{" "}
